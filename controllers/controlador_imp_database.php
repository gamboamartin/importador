...
class controlador_imp_database extends _ctl_parent_sin_codigo {
    ...
    final protected function campos_view(array $inputs = array()): array
    {
        ...
        $keys->selects['imp_server'] = new stdClass();
        $keys->selects['imp_server']->name_model = 'imp_server';
        $keys->selects['imp_server']->namespace_model = 'gamboamartin\\importador\\models';
    ...
    protected function key_selects_txt(array $keys_selects): array
    {
        ...
        $keys_selects = (new \base\controller\init())->key_select_txt(cols: 6,key: 'tipo', keys_selects:$keys_selects, place_holder: 'Tipo');
        if(errores::$error){
            return $this->errores->error(mensaje: 'Error al maquetar key_selects',data:  $keys_selects);
        }
