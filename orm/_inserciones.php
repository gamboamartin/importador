...
class _inserciones{
    ...
    final public function aplica_inserciones(array $imp_destino, PDO $link, int $usuario_id){
        ...
        $ejecuciones = $this->ejecuta_inserciones(imp_database_id: $imp_destino['imp_database_id'], link: $link, name_model: $name_model, rows: $rows, usuario_id: $usuario_id);
        if(errores::$error){
